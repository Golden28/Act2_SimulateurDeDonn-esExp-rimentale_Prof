...
Lugéné = [0.0, 3.0, 4.5, 6.0, 7.5, 9.0, 12.0]  # Listes des valeurs indiqué sur le générateur de tension prévue pour le tp

U = [u + gauss(0, 0.05) for u in Lugéné]  # Ajout d'une erreur aléatoire de type distribution gaussienne aux valeurs affichées sur l'appareil
